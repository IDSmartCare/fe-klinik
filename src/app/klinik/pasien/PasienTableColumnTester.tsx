...
const PasienTableColumnTester = [
  ...
  columHelper.accessor((row) => [row.tempatLahir, row.tanggalLahir], {
    cell: (info) => (
      <p>
        {info.getValue()[0]},{" "}
        {format(new Date(info.getValue()[1]), "dd/MM/yyyy")}
      </p>
    ),
      ...
      <div className="flex gap-1 justify-center">
        <div className="tooltip" data-tip="Riwayat Pendaftaran">
          <Link
            ...
            href={`/klinik/pendaftaran/riwayat/${info.getValue()}`}
          >
            <svg
        ...
        <div className="tooltip" data-tip="Detail Pasien">
          <Link
            ...
            href={`/klinik/pasien/detail/${info.getValue()}`}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 16 16"
        ...
        <div className="tooltip" data-tip="Registrasi">
          <Link
            ...
            href={`/klinik/pasien/registrasi/${info.getValue()}`}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 16 16"
