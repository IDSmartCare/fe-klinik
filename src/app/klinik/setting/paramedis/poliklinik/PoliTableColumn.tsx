    ...
    columHelper.accessor(row => row.id, {
        cell: info => <div className="flex gap-2 justify-center">
            <div data-tip="Hapus Poli" className="tooltip">
                <button className="btn btn-circle btn-error btn-xs" onClick={() => onDeleteData(info.getValue())} >
            ...
            <div data-tip="Edit Poli" className="tooltip">
                <Link href={`/klinik/setting/paramedis/poliklinik/edit/${info.getValue()}`} className="btn btn-circle btn-info btn-xs" >
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="size-4">
