...
const TarifTableColumn = [
    ...
    columHelper.accessor(row => row.id, {
        cell: info => <div className="tooltip" data-tip="Edit Tarif">
            <Link className="btn btn-outline btn-success btn-circle btn-xs" href={`/klinik/setting/mastertarif/edit/${info.getValue()}`}>
