...
const FarmasiTableColumn = [
    ...
    columHelper.accessor(row => [row.id, row.pendaftaran.episodePendaftaran.pasien.id, row.pendaftaranId], {
        cell: info => <div className="flex gap-1 justify-center">
            ...
            <div className="tooltip" data-tip="Resep Pasien">
                <Link className="btn btn-primary btn-outline btn-circle btn-xs" href={`/klinik/farmasi/resep/${info.getValue()[0]}/${info.getValue()[1]}/${info.getValue()[2]}`}>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="size-4">
