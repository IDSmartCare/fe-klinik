"use client";
import { createColumnHelper, RowExpanding } from "@tanstack/table-core";
...
const PerawatTableColumn = [
  ...
  columHelper.accessor(
    (row) => [row.id, row.episodePendaftaran.pasien.id, row.antrian.id],
    {
      cell: (info) => (
        <div className="flex gap-1 justify-center">
          ...
          <div className="tooltip" data-tip="Panggil Antrian">
            <button
              ...
              onClick={() =>
                handlePanggilAntrian(info.getValue()[2]?.toString())
              }
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
