...
const ModalPrintAdmisi: React.FC<ModalPrintAdmisiProps> = ({
  ...
  tanggalDaftar = getFormattedDateTime().tanggal,
  jamDaftar = getFormattedDateTime().jam,
}) => {
  return (
    <div>
            ...
            <PDFViewer style={{ width: '100%', height: '400px' }}>
              <Document>
                <Page size={[226.77, 170.08]} style={styles.page}>
                  <Text style={styles.header}>Nomor Antrian {administrasi}</Text>
                  <Text style={styles.separator}>====================================</Text>
                  <Text style={styles.ticketNumber}>{nomorAntrian}</Text>
                  <Text style={styles.separator}>====================================</Text>
                  <Text style={styles.instruction}>Silahkan menuju {administrasi} sesuai dengan yang di layar</Text>
