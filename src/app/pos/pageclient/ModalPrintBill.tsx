...
const ModalPrintBill = ({
  ...
  data: TransaksiAfterSubmit | undefined | null;
}) => {
  return (
    <div>
            ...
            <Text>{company.phone}</Text>
                ...
                {data?.transaksiPosDetail.map((item) => (
                  <View key={item.id} style={styles.item}>
                    <Text style={styles.itemName}>
                      {item.namaBarang} {item.hargaJual}
                    </Text>
                    ...
                    <Text style={styles.itemPrice}>
                      {new Intl.NumberFormat("id-ID", {
                        ...
                        Number(item.hargaSetelahDiskon) * Number(item.qty)
                      )}
                    </Text>
                  </View>
                ))}
                ...
                <Text style={styles.total}>
                  ...
                  {new Intl.NumberFormat("id-ID", {
                    style: "currency",
                    currency: "IDR",
                  }).format(Number(data?.diskonInvoice))}
                </Text>
                <Text style={styles.total}>
                  Biaya Lain:{" "}
                  {new Intl.NumberFormat("id-ID", {
                    style: "currency",
                    currency: "IDR",
                  }).format(Number(data?.biayaLainnya))}
                </Text>
                <Text style={styles.total}>
                  Total:{" "}
                  {new Intl.NumberFormat("id-ID", {
